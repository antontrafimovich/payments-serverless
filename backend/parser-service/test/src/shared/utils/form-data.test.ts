...
describe("Utils form-data", () => {
  it("parseFormData method should return parsed data on input", () => {
    const data = `
    ------WebKitFormBoundary6nBMLpSASnhgo6KW
...
1/31/2023,1/28/2023,P atno  ,-32.8,PLN,106996.89,Tytu : 010061097 744636730295702950519,Lokalizacja: Kraj: POLSKA Miasto: WARSZAWA Adres: GREEN COFFEE SP Z O O,Data i czas operacji: 2023-01-28,"Oryginalna kwota operacji: 32,80 PLN",Numer karty: 425125******0521
...
------WebKitFormBoundary6nBMLpSASnhgo6KW--
    ...
    const result = parseFormData(
      data,
      "multipart/form-data; boundary=----WebKitFormBoundary6nBMLpSASnhgo6KW"
    );
